...
'Pi rounded to {0} decimal places is {1}.'.format(5, my_pi)
# 'Pi rounded to 5 decimal places is 3.14159.'
...
# Digression on naming conventions:
# this_is_snake_case
# ThisIsCamelCase
# this.is.confusing
# ...because dots denote methods.
...
# The space avoids confusion with a float.
5.__gt__(3)
...
# Much like what we used in modules:
math.sqrt.__name__
