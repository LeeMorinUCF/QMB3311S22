...
os.chdir(drive_path + git_path + 'demo_20_Optimization')
...
# Goal is -593.02 in regression output above:
# Log-Likelihood:                -593.02
...
print(logit_model_fit_sm.params)
# These are not the same when 'maxiter': 1000.
# It takes more iterations to get a reasonable degree of accuracy.

# The objective function:
print(soln_nm.fun)
print(logit_likelihood(soln_nm.x, y, X))
# These do, however, appear the same when 'maxiter': 1000.
# It takes more iterations to get a reasonable degree of accuracy
# on the parameters but the maximum likelihood is still
