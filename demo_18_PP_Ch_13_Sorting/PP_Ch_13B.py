...
# When we run this test to see how "fast" they are, 
# we get the following results.

# length select  insert list.sort
#    10	    0.0	    0.0	    0.0	
#  1000	   97.5	   44.7	    0.1	
#  2000	  347.1	  184.8	    0.2	
#  3000	  803.0	  434.4	    0.3	
#  4000	 1397.5	  752.8	    0.4	
#  5000	 2308.4	 1200.6	    0.8	
# 10000	 8889.6	 4881.0	    1.1	

# You can see that they are much slower than the built-in sorting function, 
...
# we see that mergesort is orders of magnitude faster
# than either selection sort or insertion sort.

# Length select  insert   merge list.sort
#    10	    0.0	    0.0	    0.0	    0.0	
#  1000	   98.6	   45.0	    4.8	    0.1	
#  2000	  348.4	  183.1	    9.5	    0.3	
#  3000	  804.5	  440.3	   44.6	    0.3	
#  4000	 1445.5	  759.8	   21.2	    0.4	
#  5000	 2232.4	 1179.7	   27.6	    0.5	
# 10000	 9241.3	 4968.5	   58.2	    1.2	
